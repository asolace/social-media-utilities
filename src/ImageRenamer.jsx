  ...
  return (
    <div style={styles.fileItem}>
      <div style={styles.fileThumbWrap}>
        ...
        {item.state === STATES.ERROR && <div style={styles.thumbError}>!</div>}
      </div>
      ...
      <div style={styles.fileDetails}>
        ...
        {item.state === STATES.ERROR && (
          <div style={styles.errorRow}>
            ...
            <button style={styles.retrySmBtn} onClick={() => onRetry(index)}>
              Retry
            </button>
          </div>
        )}
...
Rules: lowercase kebab-case, specific & descriptive, under 60 chars, no extension, no special chars besides hyphens.`,
  ...
  const downloadAll = async () => {
    const readyItems = items.filter(
      (it) => it.state === STATES.DONE && it.editName,
    );
          ...
          <div style={styles.listSection}>
            <div style={styles.listHeader}>
              <span style={styles.countText}>
                ...
                {doneCount > 0 && (
                  <span style={styles.doneTag}> Â· {doneCount} renamed</span>
                )}
                {errorCount > 0 && (
                  <span style={styles.errorTag}> Â· {errorCount} failed</span>
                )}
              </span>
            ...
            <div style={styles.bottomActions}>
              {hasPending && (
                <button
                  ...
                  onClick={analyzing ? undefined : analyzeAll}
                >
                  {analyzing ? (
                    <>
